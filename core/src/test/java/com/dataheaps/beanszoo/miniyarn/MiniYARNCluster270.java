...
*/
package com.dataheaps.beanszoo.miniyarn;
...
public class MiniYARNCluster270 extends CompositeService {

  private static final Log LOG = LogFactory.getLog(MiniYARNCluster270.class);
   ...
   * @param numLogDirs the number of nm-log-dirs per nodemanager
   */
  public MiniYARNCluster270(String testName, int numNodeManagers,
                         int numLocalDirs, int numLogDirs) {
  ...
  private class NodeManagerWrapper extends AbstractService {
    ...
    private String prepareDirs(String dirType, int numDirs) {
      ...
      for (int i = 0; i < numDirs; i++) {
        dirs[i]= new File(testWorkDir, MiniYARNCluster270.this.getName()
